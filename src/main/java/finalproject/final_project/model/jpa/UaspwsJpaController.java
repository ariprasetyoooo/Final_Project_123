 ...
 */
package finalproject.final_project.model.jpa;

import finalproject.final_project.model.entity.Uaspws;
import finalproject.final_project.model.jpa.exceptions.NonexistentEntityException;
import finalproject.final_project.model.jpa.exceptions.PreexistingEntityException;
import finalproject.final_project.uascontroller.uaspws;
...
public class UaspwsJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("finalproject_final_project_jar_0.0.1-SNAPSHOTPU");
    ...
    public Uaspws findUaspws(Integer id) {
        EntityManager em = getEntityManager();
        try {
    ...
    public uaspws finduaspws(int id) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void create(uaspws uas) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void edit(uaspws uas) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    } 
